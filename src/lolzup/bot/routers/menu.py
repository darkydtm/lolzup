...
async def navigate_inline(
	...
	section = {
		...
		"menu:topics": MenuSection.TOPICS,
...
menu_router.message.register(open_topics_menu, F.text == TOPICS_TEXT)
menu_router.message.register(open_settings_menu, F.text == SETTINGS_TEXT)
menu_router.callback_query.register(
	navigate_inline,
	F.data.in_({"menu:main", "menu:topics", "menu:settings"}),
)
